...
class MainWindow(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        self.envNameLabel = QtWidgets.QLabel("Environment:")
        self.envNameDropdown = QtWidgets.QComboBox()
        self.updateComboBox(self.envNameDropdown, f'Y:/{self.project_name}/assets/ENV')
        ...
        self.updateComboBox(self.envVarDropdown, f'Y:/{self.project_name}/assets/ENV/{self.envNameDropdown.currentText()}/publish/unreal/layoutSceneDescription')
        self.envVarDropdown.setEditable(True)

        # Button 'Create Shot Folders'
        self.createShotFoldersButton = QtWidgets.QPushButton("Create ENV")
    ...
    def createENV(self):
        ...
        saveDir = path + f'/Content/01_Assets/ENV/{env_name}/{var_name}/'

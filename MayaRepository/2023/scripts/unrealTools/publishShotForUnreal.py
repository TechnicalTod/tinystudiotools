...
class MainWindow(QtWidgets.QWidget):
    ...
    def populatePublishTree(self):
        ...
        self.cameraGroup = QtGui.QStandardItem(QtGui.QIcon("{}snapshotTools.png".format(mayaFilePaths.mayaShelfIconPath)), "Cameras")
        self.puppetGroup = QtGui.QStandardItem(QtGui.QIcon("{}centerPivot.png".format(mayaFilePaths.mayaShelfIconPath)), "Puppets")
        self.shotInfoGroup = QtGui.QStandardItem(QtGui.QIcon("{}techvis.png".format(mayaFilePaths.mayaShelfIconPath)), "Shot Info")
        self.extraInfoGroup = QtGui.QStandardItem(QtGui.QIcon("{}modelling.png".format(mayaFilePaths.mayaShelfIconPath)), "Extra Info")
        self.makeItemBold([self.cameraGroup, self.puppetGroup, self.shotInfoGroup, self.extraInfoGroup], QtCore.Qt.black)
    ...
    def getExportDir(self):
        ...
        episode = shotNumber.split("_")[0]  # Assumes the first three characters represent the episode
        seq = "{}_{}".format(shotNumber.split("_")[0], shotNumber.split("_")[1])
        # Construct directory path
        publishDir = "{}/{}/{}/publish/unreal/sceneDescription/{}/".format(episode, seq, shotNumber, versionNumber)
        ...
        for item in jsonData:
            if 'Shot Info' in item:
                for info in item['Shot Info']:
                    ...
                    if 'Project' in info:
                        project = info['Project'][0]
        sceneDescriptionPath = self.buildExportPath("ShotDesciption", project, shotNumber, versionNumber, '.json')
    ...
    def collectPublishData(self):
        ...
        try:
            ...
            for cameraDict in cameraList:
                ...
                for camera, attrs in cameraDict.items():
                    ...
                    cameraExportPath = self.buildExportPath(camera, project, shotNumber, versionNumber, '.fbx')
        ...
        try:
            ...
            for puppetDict in puppetList:
                ...
                for puppet, attrs in puppetDict.items():
                    ...
                    puppetExportPath = self.buildExportPath(puppet.split(":")[0], project, shotNumber, versionNumber, '.fbx')
        ...
        jsonExportPath = self.buildExportPath("ShotDesciption", project, shotNumber, versionNumber, '.json')
    ...
    def processCamera(self, camName, exportPath):
        ...
        pm.bakeResults(duplicatedCamera,
                    simulation=True,
    ...
    def processPuppet(self, puppetName, exportPath):
        ...
        duplicatedPuppet = pm.duplicate(puppetName, name=puppetName + "_puppetExport", un=True, ic=True)[0]
        try:
